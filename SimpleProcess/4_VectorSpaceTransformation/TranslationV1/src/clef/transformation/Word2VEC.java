...
public class Word2VEC
{
	public static void main(String[] args) throws IOException
	{
		...
		vec.loadModel(Util.corpusPath + lang + ".corpus.bin");

		System.out.println("One word analysis");
		Set<WordEntry> result = new TreeSet<WordEntry>();
		
//		String[] words = Files.readFromFile(new File(lang + ".txt"), "UTF-8")
//				.split("\n");
//		for (int i = 0; i < words.length; i++)
//		{
//			result = vec.distance(words[i]);
//			if(result != null)
//			{
//				System.out.println(words[i]);
//			}
//		}
		result = vec.distance("un");
	...
	public Set<WordEntry> distance(float[] wordVector)
	{
		if (wordVector == null)
		{
			return null;
	 ...
	 * @return
	 */
	public TreeSet<WordEntry> analogy(String word0, String word1,
			String word2)
	{
		...
		{
			name = entry.getKey();
			if (name.equals(word0) || name.equals(word1)
					|| name.equals(word2))
			{
				continue;
			}
