...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdemo-classes.sh&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdemo-classes.sh" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/word2vec/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>demo-classes.sh</span>
 ...
 <li><a href="/p/word2vec/source/browse/trunk/demo-classes.sh?r=18" title="Previous">&lsaquo;r18</a></li>
...
><td class="source">time ./word2vec -train text8 -output classes.txt -cbow 1 -size 200 -window 8 -negative 25 -hs 0 -sample 1e-4 -threads 20 -iter 15 -classes 500<br></td></tr
><tr
id=sl_svn42_7

><td class="source">sort classes.txt -k 2 -n &gt; classes.sorted.txt<br></td></tr
><tr
id=sl_svn42_8

><td class="source">echo The word classes were saved to file classes.sorted.txt<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 by tmikolov
 on Sep 6, 2014
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=38&amp;format=side&amp;path=/trunk/demo-classes.sh&amp;old_path=/trunk/demo-classes.sh&amp;old=18">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/demo-classes.sh';
 ...
 Project members,
 <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdemo-classes.sh&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdemo-classes.sh"
 ...
 <a href="/p/word2vec/source/detail?spec=svn42&r=18">r18</a>
 by tmiko...@google.com
 on Aug 1, 2013
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=18&amp;format=side&amp;path=/trunk/demo-classes.sh&amp;old_path=/trunk/demo-classes.sh&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">aa</pre>
 </div>
 
 
 <a href="/p/word2vec/source/list?path=/trunk/demo-classes.sh&start=38">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//word2vec.googlecode.com/svn/trunk/demo-classes.sh">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn42': '/trunk/demo-classes.sh'}
