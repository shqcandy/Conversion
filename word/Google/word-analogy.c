...
<head>
 ...
 var CS_env = {"loggedInUserEmail": null, "projectName": "word2vec", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "projectHomeUrl": "/p/word2vec", "token": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/8599073060794244502", "profileUrl": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fword-analogy.c&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fword-analogy.c" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/word2vec/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>word-analogy.c</span>
 ...
 <li><a href="/p/word2vec/source/browse/trunk/word-analogy.c?r=12" title="Previous">&lsaquo;r12</a></li>
...
><td class="source">  char bestw[N][max_size];<br></td></tr
><tr
id=sl_svn42_28
...
><td class="source">    printf(&quot;Usage: ./word-analogy &lt;FILE&gt;\nwhere FILE contains word projections in the BINARY FORMAT\n&quot;);<br></td></tr
><tr
id=sl_svn42_36
...
><td class="source">    printf(&quot;Enter three words (EXIT to break): &quot;);<br></td></tr
><tr
id=sl_svn42_71
...
><td class="source">    if (cn &lt; 3) {<br></td></tr
><tr
id=sl_svn42_98

><td class="source">      printf(&quot;Only %lld words were entered.. three words are needed at the input to perform the calculation\n&quot;, cn);<br></td></tr
><tr
id=sl_svn42_99
...
><td class="source">      if (b == words) b = 0;<br></td></tr
><tr
id=sl_svn42_104
...
><td class="source">      if (b == 0) {<br></td></tr
><tr
id=sl_svn42_107
...
><td class="source">    if (b == 0) continue;<br></td></tr
><tr
id=sl_svn42_112
...
><td class="source">    for (a = 0; a &lt; size; a++) vec[a] = M[a + bi[1] * size] - M[a + bi[0] * size] + M[a + bi[2] * size];<br></td></tr
><tr
id=sl_svn42_114
...
><td class="source">      if (c == bi[0]) continue;<br></td></tr
><tr
id=sl_svn42_122

><td class="source">      if (c == bi[1]) continue;<br></td></tr
><tr
id=sl_svn42_123

><td class="source">      if (c == bi[2]) continue;<br></td></tr
><tr
id=sl_svn42_124
...
<script type="text/javascript">
 ...
 by tmikolov
 on Sep 8, 2014
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=39&amp;format=side&amp;path=/trunk/word-analogy.c&amp;old_path=/trunk/word-analogy.c&amp;old=12">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/word-analogy.c';
 ...
 Project members,
 <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fword-analogy.c&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fword-analogy.c"
 ...
 <a href="/p/word2vec/source/detail?spec=svn42&r=12">r12</a>
 by tmiko...@google.com
 on Jul 31, 2013
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=12&amp;format=side&amp;path=/trunk/word-analogy.c&amp;old_path=/trunk/word-analogy.c&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">demo code for comupting analogies with
the word vectors</pre>
 </div>
 
 
 <a href="/p/word2vec/source/list?path=/trunk/word-analogy.c&start=39">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//word2vec.googlecode.com/svn/trunk/word-analogy.c">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn42': '/trunk/word-analogy.c'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail": null, "projectName": "word2vec", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "projectHomeUrl": "/p/word2vec", "token": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/8599073060794244502", "profileUrl": null}, '', 'svn42', paths,
