...
<head>
 ...
 var CS_env = {"projectHomeUrl": "/p/word2vec", "relativeBaseUrl": "", "loggedInUserEmail": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/8599073060794244502", "profileUrl": null, "domainName": null, "projectName": "word2vec", "token": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdemo-analogy.sh&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdemo-analogy.sh" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/word2vec/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>demo-analogy.sh</span>
 ...
 <li><a href="/p/word2vec/source/browse/trunk/demo-analogy.sh?r=17" title="Previous">&lsaquo;r17</a></li>
...
><td class="source">if [ ! -e text8 ]; then<br></td></tr
><tr
id=sl_svn42_3

><td class="source">  wget http://mattmahoney.net/dc/text8.zip -O text8.gz<br></td></tr
><tr
id=sl_svn42_4

><td class="source">  gzip -d text8.gz -f<br></td></tr
><tr
id=sl_svn42_5
...
><td class="source">echo Note that for the word analogy to perform well, the model should be trained on much larger data set<br></td></tr
><tr
id=sl_svn42_8

><td class="source">echo Example input: paris france berlin<br></td></tr
><tr
id=sl_svn42_9
...
><td class="source">time ./word2vec -train text8 -output vectors.bin -cbow 1 -size 200 -window 8 -negative 25 -hs 0 -sample 1e-4 -threads 20 -binary 1 -iter 15<br></td></tr
><tr
id=sl_svn42_11

><td class="source">./word-analogy vectors.bin<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 by tmikolov
 on Sep 6, 2014
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=38&amp;format=side&amp;path=/trunk/demo-analogy.sh&amp;old_path=/trunk/demo-analogy.sh&amp;old=17">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/demo-analogy.sh';
 ...
 Project members,
 <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdemo-analogy.sh&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdemo-analogy.sh"
 ...
 <a href="/p/word2vec/source/detail?spec=svn42&r=17">r17</a>
 by tmiko...@google.com
 on Aug 1, 2013
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=17&amp;format=side&amp;path=/trunk/demo-analogy.sh&amp;old_path=/trunk/demo-analogy.sh&amp;old=13">Diff</a>
 <br>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/word2vec/source/detail?spec=svn42&r=13">r13</a>
 by tmiko...@google.com
 on Jul 31, 2013
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=13&amp;format=side&amp;path=/trunk/demo-analogy.sh&amp;old_path=/trunk/demo-analogy.sh&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">aa</pre>
 </div>
 
 
 <a href="/p/word2vec/source/list?path=/trunk/demo-analogy.sh&start=38">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//word2vec.googlecode.com/svn/trunk/demo-analogy.sh">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn42': '/trunk/demo-analogy.sh'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl": "/p/word2vec", "relativeBaseUrl": "", "loggedInUserEmail": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/8599073060794244502", "profileUrl": null, "domainName": null, "projectName": "word2vec", "token": null}, '', 'svn42', paths,
