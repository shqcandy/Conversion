...
<head>
 ...
 var CS_env = {"loggedInUserEmail": null, "projectHomeUrl": "/p/word2vec", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectName": "word2vec", "profileUrl": null, "token": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/8599073060794244502", "relativeBaseUrl": "", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdistance.c&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdistance.c" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/word2vec/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>distance.c</span>
 ...
 <li><a href="/p/word2vec/source/browse/trunk/distance.c?r=37" title="Previous">&lsaquo;r37</a></li>
...
><td class="source">const long long N = 40;                  // number of closest words that will be shown<br></td></tr
><tr
id=sl_svn42_22
...
><td class="source">  char st1[max_size];<br></td></tr
><tr
id=sl_svn42_27

><td class="source">  char *bestw[N];<br></td></tr
><tr
id=sl_svn42_28

><td class="source">  char file_name[max_size], st[100][max_size];<br></td></tr
><tr
id=sl_svn42_29
...
><td class="source">  long long words, size, a, b, c, d, cn, bi[100];<br></td></tr
><tr
id=sl_svn42_31

><td class="source">  char ch;<br></td></tr
><tr
id=sl_svn42_32
...
><td class="source">    printf(&quot;Usage: ./distance &lt;FILE&gt;\nwhere FILE contains word projections in the BINARY FORMAT\n&quot;);<br></td></tr
><tr
id=sl_svn42_36
...
><td class="source">  vocab = (char *)malloc((long long)words * max_w * sizeof(char));<br></td></tr
><tr
id=sl_svn42_47

><td class="source">  for (a = 0; a &lt; N; a++) bestw[a] = (char *)malloc(max_size * sizeof(char));<br></td></tr
><tr
id=sl_svn42_48

><td class="source">  M = (float *)malloc((long long)words * (long long)size * sizeof(float));<br></td></tr
><tr
id=sl_svn42_49
...
><td class="source">    printf(&quot;Cannot allocate memory: %lld MB    %lld  %lld\n&quot;, (long long)words * size * sizeof(float) / 1048576, words, size);<br></td></tr
><tr
id=sl_svn42_51
...
><td class="source">    printf(&quot;Enter word or sentence (EXIT to break): &quot;);<br></td></tr
><tr
id=sl_svn42_72
...
><td class="source">      st1[a] = fgetc(stdin);<br></td></tr
><tr
id=sl_svn42_75

><td class="source">      if ((st1[a] == &#39;\n&#39;) || (a &gt;= max_size - 1)) {<br></td></tr
><tr
id=sl_svn42_76

><td class="source">        st1[a] = 0;<br></td></tr
><tr
id=sl_svn42_77
...
><td class="source">    cn = 0;<br></td></tr
><tr
id=sl_svn42_83

><td class="source">    b = 0;<br></td></tr
><tr
id=sl_svn42_84

><td class="source">    c = 0;<br></td></tr
><tr
id=sl_svn42_85
...
><td class="source">      st[cn][b] = st1[c];<br></td></tr
><tr
id=sl_svn42_87
...
><td class="source">      st[cn][b] = 0;<br></td></tr
><tr
id=sl_svn42_90

><td class="source">      if (st1[c] == 0) break;<br></td></tr
><tr
id=sl_svn42_91

><td class="source">      if (st1[c] == &#39; &#39;) {<br></td></tr
><tr
id=sl_svn42_92
...
><td class="source">    for (a = 0; a &lt; cn; a++) {<br></td></tr
><tr
id=sl_svn42_99

><td class="source">      for (b = 0; b &lt; words; b++) if (!strcmp(&amp;vocab[b * max_w], st[a])) break;<br></td></tr
><tr
id=sl_svn42_100

><td class="source">      if (b == words) b = -1;<br></td></tr
><tr
id=sl_svn42_101

><td class="source">      bi[a] = b;<br></td></tr
><tr
id=sl_svn42_102
...
><td class="source">      if (b == -1) {<br></td></tr
><tr
id=sl_svn42_104

><td class="source">        printf(&quot;Out of dictionary word!\n&quot;);<br></td></tr
><tr
id=sl_svn42_105
...
><td class="source">    if (b == -1) continue;<br></td></tr
><tr
id=sl_svn42_109
...
><td class="source">    for (a = 0; a &lt; size; a++) vec[a] = 0;<br></td></tr
><tr
id=sl_svn42_111

><td class="source">    for (b = 0; b &lt; cn; b++) {<br></td></tr
><tr
id=sl_svn42_112

><td class="source">      if (bi[b] == -1) continue;<br></td></tr
><tr
id=sl_svn42_113

><td class="source">      for (a = 0; a &lt; size; a++) vec[a] += M[a + bi[b] * size];<br></td></tr
><tr
id=sl_svn42_114
...
><td class="source">    for (a = 0; a &lt; size; a++) len += vec[a] * vec[a];<br></td></tr
><tr
id=sl_svn42_117
...
><td class="source">    for (a = 0; a &lt; size; a++) vec[a] /= len;<br></td></tr
><tr
id=sl_svn42_119

><td class="source">    for (a = 0; a &lt; N; a++) bestd[a] = -1;<br></td></tr
><tr
id=sl_svn42_120
...
><td class="source">      for (b = 0; b &lt; cn; b++) if (bi[b] == c) a = 1;<br></td></tr
><tr
id=sl_svn42_124

><td class="source">      if (a == 1) continue;<br></td></tr
><tr
id=sl_svn42_125
...
><td class="source">    for (a = 0; a &lt; N; a++) printf(&quot;%50s\t\t%f\n&quot;, bestw[a], bestd[a]);<br></td></tr
><tr
id=sl_svn42_140
...
<script type="text/javascript">
 ...
 by tmikolov
 on Sep 8, 2014
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=39&amp;format=side&amp;path=/trunk/distance.c&amp;old_path=/trunk/distance.c&amp;old=37">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/distance.c';
 ...
 Project members,
 <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdistance.c&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fword2vec%2Fsource%2Fbrowse%2Ftrunk%2Fdistance.c"
 ...
 <a href="/p/word2vec/source/detail?spec=svn42&r=37">r37</a>
 by tmiko...@google.com
 on Dec 18, 2013
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=37&amp;format=side&amp;path=/trunk/distance.c&amp;old_path=/trunk/distance.c&amp;old=36">Diff</a>
 <br>
 <pre class="ifOpened">and fixed the minimal cosine
similarity to be -1 instead of 0</pre>
 </div>
 
 <div class="closed" style="margin-bottom:3px;" >
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/word2vec/source/detail?spec=svn42&r=36">r36</a>
 by tmiko...@google.com
 on Dec 18, 2013
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=36&amp;format=side&amp;path=/trunk/distance.c&amp;old_path=/trunk/distance.c&amp;old=31">Diff</a>
 <br>
 <pre class="ifOpened">updated the code so that it would run
even with extremely large N (number of
closest words), such as 5000</pre>
 </div>
 
 <div class="closed" style="margin-bottom:3px;" >
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/word2vec/source/detail?spec=svn42&r=31">r31</a>
 by tmiko...@google.com
 on Aug 12, 2013
 &nbsp; <a href="/p/word2vec/source/diff?spec=svn42&r=31&amp;format=side&amp;path=/trunk/distance.c&amp;old_path=/trunk/distance.c&amp;old=30">Diff</a>
 <br>
 <pre class="ifOpened">distance -&gt; cosine distance</pre>
 </div>
 
 
 <a href="/p/word2vec/source/list?path=/trunk/distance.c&start=39">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//word2vec.googlecode.com/svn/trunk/distance.c">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn42': '/trunk/distance.c'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail": null, "projectHomeUrl": "/p/word2vec", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectName": "word2vec", "profileUrl": null, "token": null, "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/8599073060794244502", "relativeBaseUrl": "", "domainName": null}, '', 'svn42', paths,
